...
declare interface DuktapeInterface {
  /**
   * 
   * @param type hex,base64,JX,JC
   * @param data 
   */
  enc(type: string, data: any): any
  /**
   * 
   * @param type hex,base64,JX,JC
   * @param data 
   */
  dec(type: string, data: any): any
}

declare var Duktape: DuktapeInterface
